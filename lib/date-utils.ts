 ...
 */
export const formatDateIsrael = (date: Date): string => {
 ...
 */
export const getCurrentDateIsrael = (): Date => {
 ...
 * Add days to a date
 */
export const addDaysIsrael = (date: Date, days: number): Date => {
 ...
 */
export const getOpenDays = (startDate: Date, totalDays: number): { openDays: Date[]; closedDaysCount: number } => {
  const openDays: Date[] = []
