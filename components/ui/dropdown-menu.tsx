    ...
    <DropdownMenuPrimitive.Portal>
      <DropdownMenuPrimitive.Content
        ...
        className={cn(
          ...
          "rounded-xl border border-white/30 dark:border-white/10 p-1.5",
  ...
  return (
    <DropdownMenuPrimitive.Item
      ...
      className={cn(
        ...
        "relative flex cursor-pointer items-center gap-2.5 rounded-lg px-3 py-2 text-sm outline-hidden select-none transition-colors",
